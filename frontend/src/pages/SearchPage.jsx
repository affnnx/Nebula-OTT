		...
		<div className=' min-h-screen text-white'>
			...
			<div className='mx-auto px-4 py-8'>
				<div className='flex justify-center gap-3 mb-4'>
					<button
						className={`py-2 px-4 rounded ${
							activeTab === "movie" ? "bg-violet-600" : "bg-gray-800"
						} hover:bg-violet-700`}
					...
					<button
						className={`py-2 px-4 rounded ${
							activeTab === "tv" ? "bg-violet-600" : "bg-gray-800"
						} hover:bg-violet-700`}
					...
					<button
						className={`py-2 px-4 rounded ${
							activeTab === "person" ? "bg-violet-600" : "bg-gray-800"
						} hover:bg-violet-700`}
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
					{results.map((result) => {
						// if (!result.poster_path && !result.profile_path) return null;  //skips if there's no image
